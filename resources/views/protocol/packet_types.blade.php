...
@push('styles')
<link rel="stylesheet" href="{{ asset('assets/css/portal/pages/protocol-packet-types.css') }}?v={{ filemtime(public_path('assets/css/portal/pages/protocol-packet-types.css')) }}">
@endpush
@section('content')
