...
@push('styles')
<link rel="stylesheet" href="{{ asset('assets/css/portal/pages/test-plans-validate.css') }}?v={{ filemtime(public_path('assets/css/portal/pages/test-plans-validate.css')) }}">
@endpush
