...
@push('styles')
<link rel="stylesheet" href="{{ asset('assets/css/portal/pages/view-devicecategory.css') }}?v={{ filemtime(public_path('assets/css/portal/pages/view-devicecategory.css')) }}">
@endpush
@section('content')
@php
